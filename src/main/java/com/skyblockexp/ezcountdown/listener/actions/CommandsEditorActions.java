...
public class CommandsEditorActions implements GuiAction {
    ...
    private static final class AddCommandConsumer implements java.util.function.Consumer<String> {
        ...
        public void accept(String input) {
            ...
            if (manager.updateCountdown(cdName, newCd)) { manager.save(); player.sendMessage(messageManager.message("gui.commands.added", java.util.Map.of("name", cdName))); registry.scheduler().runTask(() -> commandsEditor.openCommandsEditor(player, newCd)); }
        }
    }
