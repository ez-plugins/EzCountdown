...
public class EditFormatMessageAction implements GuiAction {
    ...
    public EditFormatMessageAction(CountdownManager manager, MessageManager messageManager, AnvilClickListener anvilHandler) {
    ...
    public ActionResult handle(InventoryClickEvent event, Player player, String cdName, Optional<Countdown> countdownOpt) {
        ...
        anvilHandler.request(player, new FormatInputConsumer(player, cd, cdName, manager, messageManager));
    ...
    private static final class FormatInputConsumer implements java.util.function.Consumer<String> {
        ...
        FormatInputConsumer(Player player, Countdown cd, String cdName, CountdownManager manager, MessageManager messageManager) {
            this.player = player;
            this.cd = cd;
            this.cdName = cdName;
            this.manager = manager;
