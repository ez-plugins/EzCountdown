...
public final class EditEndSoundAction implements GuiAction {
    ...
    public EditEndSoundAction(CountdownManager manager, MessageManager messageManager, ChatInputListener chatInputListener, com.skyblockexp.ezcountdown.bootstrap.Registry registry) {
    ...
    public ActionResult handle(InventoryClickEvent event, Player player, String cdName, Optional<Countdown> countdownOpt) {
        ...
        player.sendMessage(org.bukkit.ChatColor.GRAY + "Enter end sound (Bukkit Sound enum) or 'none' to disable.");
